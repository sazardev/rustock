...
/**
 * Contenido de la sección Ayuda, en castellano.
 *
 * Documenta los módulos TAL COMO funcionan en la aplicación hoy (rutas reales
 * del router, acciones y textos de los formularios, estados y comportamientos
 * que implementa el backend). Se mantiene a mano; cuando un módulo cambie, hay
 * que actualizar aquí la sección correspondiente y su equivalente en inglés.
 */
...
export const AYUDA_GRUPOS_ES: AyudaGrupo[] = [
  {
    titulo: "Empezar",
...
export const GLOSARIO_ES: TerminoGlosario[] = [
  {
    id: "almacen",
    termino: "Almacén",
    definicion:
